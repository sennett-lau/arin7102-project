...
export const Message: FC<MessageProps> = ({
  ...
  // always scroll to bottom of message when it's updated
  useEffect(() => {
  ...
  return (
    ...
    >
      <div ref={containerRef} className="relative flex max-h-[300px] w-full flex-col overflow-y-hidden p-6 sm:w-[550px] sm:px-0 md:w-[650px] lg:w-[650px] xl:w-[700px]">
